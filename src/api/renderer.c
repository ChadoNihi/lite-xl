...
static int draw_text_subpixel_impl(lua_State *L, bool draw_subpixel) {
  ...
  int font_ref = rencache_get_font_ref(L, font_desc, 1);
  x_subpixel = rencache_draw_text(L, font_desc, font_ref, text, x_subpixel, y, color, draw_subpixel, rep_table, replace_color);
